        ...
        <div className="row">
          <div className="col-sm-8 offset-sm-2 text-primary text-center -mt-52">
            <div className="relative ">
              ...
              <span className="absolute top-0 -ml-12 text-secondary font-semibold">
                Oops!
              </span>
            </div>
            <h5 className="text-muted-blue font-semibold -mr-10 -mt-3">
              Page not found
            </h5>
            <p className="text-monsoon mt-2 mb-6">

        ...
        <div className="reviews-comments-item">
          ...
          <div className="reviews-comments-item-text">
            ...
            <div className="pull-left reviews-reaction flex">
              <a
                href="#"
                className="comment-like active flex gap-1 items-center"
              >
                <FaThumbsUp /> 12
              </a>
              <a
                href="#"
                className="comment-dislike active flex gap-1 items-center"
              >
                <FaThumbsDown /> 1
              </a>
              <a
                href="#"
                className="comment-love active flex gap-1 items-center"
              >
                <FaHeart /> 07
              </a>
            </div>

...
const Hero: React.FC = () => {
  return (
    <motion.div
      initial="initial"
      animate="animate"
      className="min-h-screen h-full content_wrapper"
    >
      <motion.div
        className="content_wrapper container mx-auto h-full"
      ...
      >
        <div className="left_content_wrapper">
          ...
          <motion.p variants={fadeInUp}>
            Master a wide range of skills and certify your expertise with our
            comprehensive courses. Unlock new career opportunities and stay
